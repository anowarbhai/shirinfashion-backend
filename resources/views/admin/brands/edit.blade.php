...
@section('title', 'Edit Brand - Shirin Fashion Admin')
    ...
    <form method="POST" action="{{ route('admin.brands.update', $brand) }}">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="hidden" name="logo" id="logo-input" value="{{ old('logo', $brand->logo) }}">
                <div id="logo-preview" class="mt-3 {{ old('logo', $brand->logo) ? '' : 'hidden' }}">
                    <div class="relative inline-block">
                        <img id="logo-preview-img" src="{{ old('logo', $brand->logo) }}" alt="Logo Preview" class="h-24 object-contain rounded-lg border">
