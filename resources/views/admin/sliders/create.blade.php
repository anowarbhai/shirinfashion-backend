...
@section('title', 'Add Slider - Shirin Fashion Admin')
@section('header', 'Add New Slider')

@section('content')
<div class="max-w-5xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">Create New Slider</h2>
            <p class="text-gray-600 text-sm mt-1">Add a new banner to your homepage hero slider</p>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-rose-500 transition cursor-pointer" onclick="document.getElementById('image').click()">
                            ...
                            <div id="upload-placeholder">
                                ...
                                <p class="text-gray-400 text-xs mt-1">Recommended: 1920x700 pixels</p>
                            </div>
                            <input type="file" id="image" name="image" accept="image/*" class="hidden" required onchange="previewImage(this)">
                        </div>
                        @error('image')
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <label class="cursor-pointer">
                                <input type="radio" name="content_position" value="top" {{ old('content_position', 'center') == 'top' ? 'checked' : '' }} class="sr-only peer">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="content_position" value="center" {{ old('content_position', 'center') == 'center' ? 'checked' : '' }} class="sr-only peer">
                                <div class="px-3 py-2 text-center text-sm rounded-lg border-2 border-gray-200 peer-checked:border-rose-500 peer-checked:bg-rose-50 transition">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="content_position" value="bottom" {{ old('content_position', 'center') == 'bottom' ? 'checked' : '' }} class="sr-only peer">
                                <div class="px-3 py-2 text-center text-sm rounded-lg border-2 border-gray-200 peer-checked:border-rose-500 peer-checked:bg-rose-50 transition">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <label class="cursor-pointer">
                                <input type="radio" name="text_align" value="left" {{ old('text_align', 'left') == 'left' ? 'checked' : '' }} class="sr-only peer">
                                <div class="px-3 py-2 text-center text-sm rounded-lg border-2 border-gray-200 peer-checked:border-rose-500 peer-checked:bg-rose-50 transition">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="text_align" value="center" {{ old('text_align', 'left') == 'center' ? 'checked' : '' }} class="sr-only peer">
                                <div class="px-3 py-2 text-center text-sm rounded-lg border-2 border-gray-200 peer-checked:border-rose-500 peer-checked:bg-rose-50 transition">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="text_align" value="right" {{ old('text_align', 'left') == 'right' ? 'checked' : '' }} class="sr-only peer">
                                <div class="px-3 py-2 text-center text-sm rounded-lg border-2 border-gray-200 peer-checked:border-rose-500 peer-checked:bg-rose-50 transition">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="subtitle" rows="3"
                            ...
                            placeholder="e.g., Discover the latest trends with up to 50% off">{{ old('subtitle') }}</textarea>
                    </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="button_color" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-rose-500">
                                        <option value="rose" {{ old('button_color', 'rose') == 'rose' ? 'selected' : '' }}>Rose</option>
                                        <option value="blue" {{ old('button_color') == 'blue' ? 'selected' : '' }}>Blue</option>
                                        <option value="green" {{ old('button_color') == 'green' ? 'selected' : '' }}>Green</option>
                                        <option value="purple" {{ old('button_color') == 'purple' ? 'selected' : '' }}>Purple</option>
                                        <option value="orange" {{ old('button_color') == 'orange' ? 'selected' : '' }}>Orange</option>
                                        <option value="dark" {{ old('button_color') == 'dark' ? 'selected' : '' }}>Dark</option>
                                        <option value="white" {{ old('button_color') == 'white' ? 'selected' : '' }}>White</option>
                                        <option value="outline" {{ old('button_color') == 'outline' ? 'selected' : '' }}>Outline</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="button_2_color" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-rose-500">
                                        <option value="outline" {{ old('button_2_color', 'outline') == 'outline' ? 'selected' : '' }}>Outline</option>
                                        <option value="rose" {{ old('button_2_color') == 'rose' ? 'selected' : '' }}>Rose</option>
                                        <option value="blue" {{ old('button_2_color') == 'blue' ? 'selected' : '' }}>Blue</option>
                                        <option value="green" {{ old('button_2_color') == 'green' ? 'selected' : '' }}>Green</option>
                                        <option value="purple" {{ old('button_2_color') == 'purple' ? 'selected' : '' }}>Purple</option>
                                        <option value="orange" {{ old('button_2_color') == 'orange' ? 'selected' : '' }}>Orange</option>
                                        <option value="dark" {{ old('button_2_color') == 'dark' ? 'selected' : '' }}>Dark</option>
                                        <option value="white" {{ old('button_2_color') == 'white' ? 'selected' : '' }}>White</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Button Link</label>
                                <input type="text" name="button_2_link" value="{{ old('button_2_link') }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
