...
@section('title', 'Add Category - Shirin Fashion Admin')
    ...
    <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-rose-500">{{ old('description') }}</textarea>
            </div>
            <div>
                ...
                <div id="image-preview" class="mt-3 {{ old('image') ? '' : 'hidden' }}">
                    <div class="relative inline-block">
                        <img id="image-preview-img" src="{{ old('image') }}" alt="Category Image" class="w-32 h-32 object-cover rounded-lg border">
            ...
            <div class="flex items-center"><input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-4 h-4 text-rose-600 border-gray-300 rounded"><label class="ml-2 text-sm text-gray-700">Active</label></div>
        </div>
        <div class="mt-8 flex justify-end space-x-4">
            ...
            <button type="submit" class="px-6 py-2 bg-rose-600 text-white rounded-lg hover:bg-rose-700">Save Category</button>
        </div>
    </form>
</div>
