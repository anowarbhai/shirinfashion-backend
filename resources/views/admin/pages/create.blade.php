...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form action="{{ route('admin.pages.store') }}" method="POST" class="space-y-6" id="page-form">
            @csrf
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">URL will be: <span id="url-preview">{{ url('/page/') }}/your-slug</span></p>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Content</label>
                <div id="content-editor" class="bg-white border border-gray-300 rounded-lg">{!! old('content') !!}</div>
...
<script>
    ...
    function checkSlug(slug) {
        ...
        .then(data => {
            if (data.exists) {
                document.getElementById('slug-status').innerHTML = '<span class="slug-exists">This slug is already in use. A unique slug will be generated.</span>';
            } else {
